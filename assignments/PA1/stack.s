...
class_objTab:
	...
	.word	ExitCommand_protObj
	.word	ExitCommand_init
...
PushCommand_dispTab:
	...
	.word	Object.copy
	.word	StackCommand.from
	.word	PushCommand.eval
	.word	PushCommand.with
ExitCommand_dispTab:
	.word	Object.abort
	.word	Object.type_name
	.word	Object.copy
	.word	StackCommand.from
	.word	ExitCommand.eval
DisplayCommand_dispTab:
	.word	Object.abort
	.word	Object.type_name
	.word	Object.copy
	.word	StackCommand.from
	.word	DisplayCommand.eval
EvalCommand_dispTab:
	.word	Object.abort
	.word	Object.type_name
	.word	Object.copy
	.word	StackCommand.from
	.word	EvalCommand.eval
	.word	EvalCommand.add
	.word	EvalCommand.swap
StackMachine_dispTab:
	.word	Object.abort
	.word	Object.type_name
	.word	Object.copy
	.word	StackMachine.alive
	.word	StackMachine.list
...
label104:
	lw	$t1 12($a0)
	beqz	$t1 label102
	la	$a0 ExitCommand_protObj
	jal	Object.copy
	jal	ExitCommand_init
	b	label103
label102:
	lw	$s1 16($fp)
	la	$t2 str_const3
